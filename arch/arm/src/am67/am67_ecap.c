 ...
 *   at boot, so an unpowered module fails the open instead of hanging boot.
 *   No output until start().
 *
 * Returned Value:
 *   Zero (OK) on success; a negated errno if the module is not alive.
 *
 ****************************************************************************/
