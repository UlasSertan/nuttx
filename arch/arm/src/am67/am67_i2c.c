...
#define MKI2C_OUTPUT(p) (am67_periph_gpio(p) | PINMUX_SLEW_SLOW | \
...
struct am67_trace_s
{
  ...
  enum am67_intstate_e event; /* Last event that occurred with this status */
...
static void am67_i2c_setclock(struct am67_i2c_priv_s *priv,
                                uint32_t frequency);
static inline void am67_i2c_sendstart(struct am67_i2c_priv_s *priv,
                                        uint16_t address);
...
static int am67_i2c_reset(struct i2c_master_s *dev);
#endif
...
static const struct am67_i2c_config_s am67_i2c1_config =
{
  .base       = AM67_I2C1_VADDR,
...
static struct am67_i2c_priv_s am67_i2c1_priv =
{
  .ops        = &am67_i2c_ops,
  .config     = &am67_i2c1_config,
  .refs       = 0,
  .lock       = NXMUTEX_INITIALIZER,
#ifndef CONFIG_I2C_POLLED
  .sem_isr    = SEM_INITIALIZER(0),
  ...
  if (priv->config->mode == I2C_MASTER)
    {
      if ((priv->flags & I2C_M_READ) != 0)
        {
          ...
          am67_i2c_putreg(priv, AM67_I2C_IRQ_EN_SET_OFFSET, regval);
        }
      else
        {
      ...
      am67_i2c_putreg(priv, AM67_I2C_IRQ_STAT_RAW_OFFSET, I2C_IRQ_BF);
    }
                                        ...
                                        uint16_t address)
{
  ...
  regval = am67_i2c_getreg(priv, AM67_I2C_CON_OFFSET) | I2C_CON_STT |
                                   I2C_CON_MST;
  ...
  am67_i2c_putreg(priv, AM67_I2C_SA_OFFSET, address);
...
static int am67_i2c_isr_process(struct am67_i2c_priv_s *priv)
{
          ...
          if ((priv->flags & I2C_M_NOSTART) == 0)
            {
              ...
              am67_i2c_sendstart(priv, priv->msgv->addr);
            }
          else
            {
  ...
  if ((status & I2C_IRQ_ERRORMASK) != 0)
    {
      am67_i2c_traceevent(priv, I2CEVENT_ERROR, 0);
  ...
  am67_i2c_putreg(priv, AM67_I2C_IRQ_STAT_OFFSET, status);
...
static int am67_i2c_init(struct am67_i2c_priv_s *priv)
{
  ...
  am67_i2c_modifyreg(priv, AM67_I2C_SYSC_OFFSET, I2C_SYSC_AUTOIDLE, 0);
...
static int am67_i2c_reset(struct i2c_master_s *dev)
{
  ...
  am67_gpio_config(scl_gpio);
  am67_gpio_config(sda_gpio);

  /* Let SDA go high */

  am67_gpio_write(sda_gpio, 1);

  /* Clock the bus until any slaves currently driving it let it go. */

  clock_count = 0;
  while (!am67_gpio_read(sda_gpio))
    {
      ...
      am67_gpio_write(scl_gpio, 0);
      up_udelay(10);

      /* Drive SCL high again */

      am67_gpio_write(scl_gpio, 1);
      up_udelay(10);
    }
  ...
  am67_i2c_setclock(priv, frequency);
  ret = OK;
...
#ifdef CONFIG_AM67_I2C1
    case 1:
      priv = (struct am67_i2c_priv_s *)&am67_i2c1_priv;
      break;
#endif
#ifdef CONFIG_AM67_WKUP_I2C0
    case 2:
...
#endif /* CONFIG_AM67_I2C0 || CONFIG_AM67_I2C1 || \
        * CONFIG_AM67_I2C2 */
